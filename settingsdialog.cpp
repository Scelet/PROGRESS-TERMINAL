...
void SettingsDialog::fillPortsInfo()
{
    ...
    for (const QSerialPortInfo &info : infos) {
        ...
        m_ui->serialPortInfoListBox->addItem(list[0]+":"+list[1], list);
    }
...
{
    m_currentSettings.name = m_ui->serialPortInfoListBox->currentText().sliced(0,m_ui->serialPortInfoListBox->currentText().indexOf(":"));
